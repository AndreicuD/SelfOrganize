   ...
   public function actionAdd()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if ($model->type === 'transfer_out') {
                // Handle transfer as two linked transactions
                ...
                // Save transfer_in as a linked transaction
                ...
                $transferIn->amount                 = $model->amount;
                $transferIn->currency               = $model->currency ?? $toAccount->currency;
