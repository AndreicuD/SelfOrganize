                ...
                <div class="finance-tab-content">
                    ...
                    <div class="finance-panel active" id="tab-transactions">
                        <div class="row g-4 mt-0">
                            ...
                            <?php
                                //php to transform given array to javascript object read by
                                //finance.js to display chart
                                $lastWeek = json_encode($balanceHistory7);
                                $lastMonth = json_encode($balanceHistory30);
                            ?>
                            ...
                            <div class="col-lg-6">
                                <div class="card col-card h-100">
                                    <div class="card-body">
                                        ...
                                        <canvas id="transfersChart" width="100%" height="40"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
